        ...
        switch (action) { //post
            ...
            case "getImageForUser":
                ...
                try {
                    ...
                    photoFilePaths = ImageDB.getUserImagePhotoPathsById(userID);
                    System.out.println("The photo paths getting from db is: " + photoFilePaths);
                } catch (SQLException ex) {
                    System.out.println("Issue with Servlet file parts -> \nError thrown:" + ex);
                }
                url = "/member/gallery.jsp";
                request.setAttribute("gallery", photoFilePaths);
                break;
